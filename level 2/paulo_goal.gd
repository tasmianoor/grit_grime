...
const _PAULO_TEX_PIXEL_H := 377.0
## Paulo’s **world height** vs Lawrence’s **measured on-screen** sprite height (includes e.g. `game_level_2` Player `scale` ~1.46).
const _PAULO_HEIGHT_VS_LAWRENCE := 1.25
...
const _WIPE_TEX: Array[Texture2D] = [
	preload("res://level 2/props/Paulo/wipe/wipe1.png"),
	preload("res://level 2/props/Paulo/wipe/wipe2.png"),
	preload("res://level 2/props/Paulo/wipe/wipe3.png"),
	preload("res://level 2/props/Paulo/wipe/wipe4.png"),
	preload("res://level 2/props/Paulo/wipe/wipe5.png"),
	preload("res://level 2/props/Paulo/wipe/wipe6.png"),
]

const _IDLE_TEX: Array[Texture2D] = [
	preload("res://level 2/props/Paulo/idle/idle1.png"),
	preload("res://level 2/props/Paulo/idle/idle2.png"),
	preload("res://level 2/props/Paulo/idle/idle3.png"),
	preload("res://level 2/props/Paulo/idle/idle4.png"),
]
...
func _physics_process(_delta: float) -> void:
	...
	for n in tree.get_nodes_in_group(&"player"):
		...
		if bool(p.call(&"is_holding_trash")):
			continue
		if _distance_point_to_paulo_aabb(p.global_position) <= INTERACT_DISTANCE_PX:
			any_in_range = true
			break

	_hint.visible = any_in_range
	if any_in_range:
		var a := _paulo_world_aabb()
...
func _distance_point_to_paulo_aabb(world_pt: Vector2) -> float:
	var a := _paulo_world_aabb()
	var q := Vector2(
