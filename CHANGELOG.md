...
| **Scene wiring** | None. `level/background/parallax_background.tscn` (and the `level 2/background/` twin) does **not** reference `smog_1/` — clouds and sun stack remain unchanged. Wiring will follow once final art lands. |
